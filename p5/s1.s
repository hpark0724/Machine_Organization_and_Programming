...
00001295 <main>:
    ...
    12b1:	81 c3 07 2d 00 00    	add    $0x2d07,%ebx     // ebx  = 0x56558fb8, using i r ebx 
...
{ fopen code in 1341 ... }
    12d2:	be 01 00 00 00       	mov    $0x1,%esi        // esi initially 1 
    ...
    12ef:	83 fe 06             	cmp    $0x6,%esi        // esi == 6이면
    12f2:	74 7f                	je     1373 <main+0xde> // 성공으로 jmp
    12f4:	8b 85 d4 fd ff ff    	mov    -0x22c(%ebp),%eax
    12fa:	39 38                	cmp    %edi,(%eax)
    12fc:	74 5f                	je     135d <main+0xc8>
    12fe:	83 ec 04             	sub    $0x4,%esp
    1301:	57                   	push   %edi             // stdin
    1302:	68 00 02 00 00       	push   $0x200           // n = 200
    1307:	8d 85 e4 fd ff ff    	lea    -0x21c(%ebp),%eax
    130d:	50                   	push   %eax             // string = ebp-0x21c (fgets 버퍼 주소)
    130e:	e8 3d fd ff ff       	call   1050 <fgets@plt> // char *fgets (char *string, int n, FILE *stream);
    1313:	83 c4 10             	add    $0x10,%esp
    1316:	85 c0                	test   %eax,%eax        // eax == 0 이면 (fgets EOF) 
    1318:	74 d5                	je     12ef <main+0x5a> 

    131a:	83 ec 04             	sub    $0x4,%esp        // pad to 16B align
    131d:	6a 0a                	push   $0xa             // base 10
    131f:	6a 00                	push   $0x0             // endptr = NULL
    1321:	8d 85 e4 fd ff ff    	lea    -0x21c(%ebp),%eax
    1327:	50                   	push   %eax             // nptr = ebp-0x21c (fgets로 얻은 버퍼 주소)
    1328:	e8 93 fd ff ff       	call   10c0 <strtol@plt>// long strtol(char *nptr, char **endptr, int base);
    132d:	83 c6 01             	add    $0x1,%esi
    1330:	83 c4 10             	add    $0x10,%esp
    1333:	39 84 b3 50 00 00 00 	cmp    %eax,0x50(%ebx,%esi,4)   // (ebx+50)[esi], esi = 2, 3, 4, 5, 6
// x/8x 0x56559008
// (ebx+50) array = {0xffffffff 0xffffffff 0x000da50f 0x00057e45 0x00038a34 0x000ad68a 0x000bca4c 0x00000000}
    133a:	74 a7                	je     12e3 <main+0x4e> // not equal fail
    ...
    1373:	e8 dc fe ff ff       	call   1254 <success> // 성공
