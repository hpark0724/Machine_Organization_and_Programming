...
00001295 <main>:
    ...
    12dd:	89 85 d4 fd ff ff    	mov    %eax,-0x22c(%ebp) // p = ebx+0x60 으로 초기값 설정 -> 0x56559018 
//0x56559008: 0x0001773e 0x000c1fbc 0x000e836e x0002218c 0x00030579 0x00000000
// 거꾸로 하면 (198009 139660 951150 794556 96062)
    ...
    1320:	83 ad d4 fd ff ff 04 	subl   $0x4,-0x22c(%ebp)    // p--;
    1327:	83 c6 01             	add    $0x1,%esi            // esi++
    132a:	8d 83 ea e0 ff ff    	lea    -0x1f16(%ebx),%eax
    1330:	89 85 cc fd ff ff    	mov    %eax,-0x234(%ebp)    // ? = -0x1f16(%ebx)

    1336:	83 fe 06             	cmp    $0x6,%esi
    1339:	74 4d                	je     1388 <main+0xf3>     // 성공
    ...
    135f:	74 d5                	je     1336 <main+0xa1>     // NULL 이면 점프
